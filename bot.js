...
coll.first().delete()
  ...
  message.guild.createChannel(name, type).then(c => {
    ...
    setTimeout(() => {
      c.delete()
      message.channel.send("تم انقتاء الوقت الكامل لا اعده التجديد اسنخدم امر !tc")
...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **Mahdi bot !**  A Nice Bot Developed By:`MHSTR`')
...
client.on('message', message => {
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By AboRoh
    let pages = [`
***__وصف عن البوت__***
**
